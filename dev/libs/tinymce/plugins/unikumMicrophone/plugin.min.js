    ...
    tooltip: 'Spela in ljud',
      ...
      if (navigator.mediaDevices.getUserMedia) {}
	      ...
	      navigator.getUserMedia = navigator.mediaDevices.getUserMedia ||
            ...
            var mp3Worker = new Worker($.get('/libs/tinymce/plugins/unikumMicrophone/mp3-worker-realtime.js', function () {
              stageController.transitionStage(0);
            }))
            console.log(mp3Worker)
					});
				} else { // It isn't
...
soundRecorder = {
  ...
  reset: function(){
    ...
    this.timer = 'START';
    console.log('reset')
    if (soundRecorder.stream) {
      soundRecorder.stream.getAudioTracks()[0].stop();
    }
    if (soundRecorder.audioCtx) {
  ...
  startRecording: function() {
    ...
    var mediaError = function(e) {
      console.log('Det går inte att starta mikrofonen.', e);
    }
