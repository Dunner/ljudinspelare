...
tinymce.PluginManager.add('unikumMicrophone', function(editor, url) {
    ...
    tooltip: 'Spela in ljud',
		onclick: function() {
			...
			$.get('/libs/tinymce/plugins/unikumMicrophone/lame.min.js', function (data) {});
        ...
        run: function() {
					...
					$('#umm_stop_recording').on('click', function(){
						...
						if (soundRecorder.recordingLength > 0) {
							var blob = soundRecorder.stopRecording();
...
soundRecorder = {
  ...
  stopRecording: function() {
    ...
    if (soundRecorder.audioCtx && soundRecorder.audioCtx.state !== 'closed') {
      ...
      var mp3 = soundRecorder.createMp3(wav, function(){
				console.log('yay')
			});
  ...
  createWAV: function(samples){
	...
	createMp3: function(blob, currCallback) {

		var fileReader = new FileReader();
		fileReader.onload = function(){
			var arrayBuffer = this.result;
			var mp3data = encode(arrayBuffer, function(dataBuffer) {
